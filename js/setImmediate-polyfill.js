...
//To ensure asynchronous generation of password
...
/* 1. window.postMessage can be used to trigger an immediate but yielding callback. */
/* 2. MessageChannel can be used reliably inside of Web Workers whereas the semantics of 
/* postMessage mean it cannot be used there. */
/* 3. setTimeout(fn, 0)can potentially be used, however as it is clamped to 4ms for timers */
/* nested more than 5 levels deep per the HTML spec, it does not make for a suitable polyfill */
/* for the natural immediacy of setImmediate. */
